...
>
> **Arnés SSD de Uncle Bob (edición artesano)** — flujo estilo Robert C.
> Martin: conversación → Gherkin → TDD → review → mutación. Ver
> `docs/workflow.md`. Python es el stack de referencia; para otro lenguaje,
> ver `docs/stack-adapter.md`.
...
| `docs/stack-adapter.md`      | Cómo adaptar el arnés a otro lenguaje (Python es el de referencia)          | Si tu stack no es Python |
| `CHECKPOINTS.md`             | Criterios objetivos de "estado final correcto"                              | Para auto-evaluarte |
| `tools/mutate.py`            | Mutador sin dependencias para la prueba de mutación (Python de referencia)  | Fase de mutación |
...
| `examples/notes-cli/`        | Ejemplo trabajado end-to-end del arnés (no lo edites; es la referencia)     | Para ver el método aplicado |
...
6. No dejes archivos temporales, ni trazas de debug, ni TODOs sin contexto.
